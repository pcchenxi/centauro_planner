...
def spatial_softmax(features,
  ...
  with ops.name_scope(name, 'spatial_softmax', [features]) as name:
    ...
    # max_v = math_ops.reduce_max(features, 1)
    softmax_attention = nn.softmax(features/temperature)
    arg_max = math_ops.argmax(softmax_attention, 1)
    arg_max_reshape = array_ops.reshape(arg_max, [-1, num_channels, 1])
    ...
    return arg_max_reshape, feature_keypoints
